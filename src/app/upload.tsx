...
export default function Screen() {
  ...
  const handleDiagnosis = async () => {
    if (!imageUri) return Alert.alert("Missing Scan", "Please scan the room first.");
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: COLORS.background }}>
      <View style={{ padding: 24 }}>
        ...
        <Text style={{ fontSize: 16, color: COLORS.textMuted, marginBottom: 24 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 12, marginBottom: 30 }}>
            <Text onPress={pickImage} style={{ color: COLORS.primary, fontWeight: '600' }}>
        ...
        {/* 3. Action Button */}
        <Button 
          title={true ? "Analyzing Geometry..." : "Run Diagnosis"} 
          onPress={handleDiagnosis}
          isLoading={true}
          icon="sparkles"
          style={{ backgroundColor: COLORS.textMain }} // Dark, serious button
        />
